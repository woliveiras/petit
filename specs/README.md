...
| [0104](0104-local-network-sync/spec.md)        | Local network sync        | Approved    | 0101, 0103 |
| [0105](0105-local-conflict-resolution/spec.md) | Local conflict resolution | In Progress | 0102       |

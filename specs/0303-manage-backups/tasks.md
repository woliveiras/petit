...
- [x] **List and inspect every recognized backup** (test-type: both)
...
- [x] **Delete one backup permanently** (test-type: both)
...
- [x] **Delete selected or all backups explicitly** (test-type: both)
  - blocked-by: previous task
